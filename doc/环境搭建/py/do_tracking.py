...
sys.path.append('/vision/got10k-toolkit')
sys.path.append('/vision/tensorpack')
sys.path.append('/vision/tensorpack/predict')
sys.path.append('/vision/SiamR-CNN')
